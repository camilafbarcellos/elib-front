                    ...
                    <body className="text-center">
                        ...
                        <main className="form-signin">
                            <form onSubmit={acaoLogin}>
                                <img class="mb-4" src="https://cdn-icons-png.flaticon.com/512/2231/2231727.png" alt="" width="82" height="82" />
                                <h1 className="h3 mb-3 fw-normal">Login de usuário</h1>

                                <div className="form-floating">
                                    <input type="text" className="form-control" id="floatingInput" placeholder="Nome de usuário ou Email"
                                        value={user}
                                        name="user"
                                        onChange={e => setUser(e.target.value)} />
                                    <label htmlFor="floatingInput">Nome de usuário ou Email</label>
                                </div>
                                <div className="form-floating">
